...
class ModelExtensionInspireBlogger extends Model {
	public function createBlogs() {
		$create_blogger = "CREATE TABLE IF NOT EXISTS `" . DB_PREFIX . "blogger` (`blogger_id` int(11) NOT NULL auto_increment, `module_id` int(11) NOT NULL, `status` int(1) NOT NULL default '0', `image` varchar(255) default NULL, `date_added` datetime NOT NULL default '2021-02-02 05:03:00', `date_modified` datetime NOT NULL default '2021-02-02 05:03:00', PRIMARY KEY (`blogger_id`)) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;";
		...
		$create_blogger_comment = "CREATE TABLE IF NOT EXISTS `" . DB_PREFIX . "blogger_comment` (`blogger_comment_id` int(11) NOT NULL auto_increment, `blogger_id` int(11) NOT NULL, `approved` int(1) NOT NULL default '0', `author` varchar(64) NOT NULL default '', `email` varchar(96) NOT NULL, `date_added` datetime NOT NULL default '2021-02-02 05:03:00', PRIMARY KEY (`blogger_comment_id`, `blogger_id`)) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;";
