...
class ControllerExtensionModuleNewslettersubscribe extends Controller {
	...
	public function index() {   
		...
		$this->load->model('inspire/newslettersubscribe');
		
		$this->model_inspire_newslettersubscribe->check_db();
		...
		$user_total = $this->model_inspire_newslettersubscribe->getTotalUsers();
		...
		$results = $this->model_inspire_newslettersubscribe->getList($data);
	...
	public function unsubscribe() {
		...
		if (isset($this->request->post['selected']) && $this->validateDelete()) {
			...
			foreach ($this->request->post['selected'] as $user_id) {
				$this->model_inspire_newslettersubscribe->delete($user_id);                
	  		}
			...
			$this->model_inspire_newslettersubscribe->delete($data);
			...
			if (!$json) {
				...
				switch ($this->request->post['to']) {
					...
					case 'sendall':
						...
						$email_total1 = $this->model_inspire_newslettersubscribe->getTotalUsers();
							
						$results1 = $this->model_inspire_newslettersubscribe->getList($customer_data);
					...
					case 'lbnewsletter':
						...
						$email_total = $this->model_inspire_newslettersubscribe->getTotalUsers();
							
						$results = $this->model_inspire_newslettersubscribe->getList($customer_data);
